#include "robot_ball_balance_v2.h"
...
void readCI() {
  ...
  double y.gyroRate = y.gy / 131.0; // Convert to deg/s
  double x.gyroRate = x.gy / 131.0; // Convert to deg/s
  ...
  x.angleKal = kalmanX.getAngle(x.angle, x.gyroRate, dt);
